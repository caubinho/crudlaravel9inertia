...
const submit = () => {
    console.log(form);
    form.put(route('permissions.update', props.datos.id));
};
</script>
            ...
            <div class="grid grid-cols-10  gap-4">
                <div class="col-span-6">
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                        Editar Permissão- <strong>{{ this.props.datos.name }}</strong>
                    </h2>
                </div>
                <div class="col-end-12 sm:col-end-10">
                    <Link :href="route('permissions.index')" class="bg-blue-600  hover:bg-blue-500 text-white  font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                        Volver
                    </Link>
                </div>
            </div>
